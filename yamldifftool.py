...
parser.add_argument("-s", "--strict", default=False, action=argparse.BooleanOptionalAction, type=bool, help="strict mode will drop all options not in default values.yaml.")
